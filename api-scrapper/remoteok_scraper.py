...
def send_email(send_from, send_to, subject, text, files=None):
    ...
    smtp.starttls()
    smtp.login(send_from, '#')   #TO BE DONE LATER CREATING A EMAIL LESS SECURE AND THEN ADDING THE MAIL ID AND PAS IN IT 
...
if __name__ == "__main__":
    ...
    send_email('#',['dhiredhami@gmail.com'],'jobs posting', 'please find the attach of the list below ', files=['remote_jobs.xls'])